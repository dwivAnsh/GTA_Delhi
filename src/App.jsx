          ...
          <div className="main w-full rotate-[10deg] scale-[1.7]">
            <div className="landing w-full h-screen bg-black relative overflow-hidden">
              ...
              <div className="imagesdiv relative w-full h-screen">
                ...
                />
                <div
                  className="text text-white w-full flex flex-col gap-[2vw] scale-[1.7] rotate-[-10deg]"
                  style={{ textShadow: "10px 4px 10px rgba(0, 0, 0, 1)" }}
                >
              ...
              <div className="btmbar absolute bottom-0 flex items-center left-0 w-full h-[16%] z-[11] bg-gradient-to-t from-black to-transparent ">
                <div className="dwn flex gap-2 absolute items-center text-white bottom-2">
              ...
              <div className="cntnr w-full h-[80%] flex text-white">
                ...
                <div className="rimg absolute left-3/3 top-2/7 -translate-x-1/2 -translate-y-1/2 w-full">
                  ...
                  <p className="absolute top-60 font-[Montserrat] w-[40%]">
                    Welcome to <strong>GTA Delhi</strong> – the fusion of
                    Delhi's chaos and Los Santos' thrill. Dive into India's most
                    immersive GTA roleplay experience!
                  </p>
                  <p className="absolute top-85 font-[Montserrat] w-[40%]">
                    Create your story, build your gang, rule the streets – only
                    at GTA Delhi.
                  </p>

                  <button className="bg-yellow-300 text-black h-12 w-[12vw] text-2xl rounded-xs absolute top-110 hover:shadow-[0_0_15px_#facc15] transition duration-300">
                    Download Now
                  </button>
                </div>
              </div>
