      ...
      {showContent && (
        <div className="main w-full rotate-[10deg] scale-[1.7]">
          <div className="landing w-full h-screen bg-black relative overflow-hidden">
            ...
            <div className="btmbar absolute bottom-0 left-0 w-full h-[15%] z-[11] bg-gradient-to-t from-black to-transparent">
              <div className="flex gap-4 absolute items-center text-white bottom-2">
                <i class="text-4xl ri-arrow-down-line"></i>
                <h3 className="font-[Montserrat] text-2xl">Scroll Down</h3>
              </div>
              <img
          ...
          <div className="second relative w-full h-screen bg-black px-10 flex items-center justify-center overflow-hidden">
            <div className="cntnr w-full h-[80%] flex text-white">
              ...
              <div className="rimg absolute left-3/3 top-2/7 -translate-x-1/2 -translate-y-1/2 w-full">
                ...
                <button className="bg-yellow-300 text-black h-12 w-[12vw] text-2xl rounded-xs absolute top-110">Download Now</button>
              </div>
            </div>
          </div>
        </div>
